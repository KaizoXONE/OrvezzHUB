...
if not isfolder("OrvezzX X") then
    makefolder("OrvezzX X")
end
if not isfolder("OrvezzX X/Config") then
    makefolder("OrvezzX X/Config")
end
...
local ConfigFile = "OrvezzX X/Config/OrvezzX_" .. gameName .. ".json"
...
local OrvezX = {}
function OrvezX:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "OrvezzX X"
    ...
    spawn(function()
        ...
        NotifyFrameReal.BackgroundTransparency = 0.2  -- Glassmorphism transparency
        ...
        -- Glassmorphism: Add subtle border to notification
        local NotifyStroke = Instance.new("UIStroke")
        NotifyStroke.Color = Color3.fromRGB(255, 140, 0)  -- Orange border
...
function OrvezX(msg, delay, color, title, desc)
    return OrvezX:MakeNotify({
        Title = title or "OrvezzX X",
        Description = desc or "Notification",
        Content = msg or "Content",
        Color = color or Color3.fromRGB(255, 140, 0),
        Delay = delay or 4
    })
end

function OrvezX:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "OrvezzX X"
    GuiConfig.Footer       = GuiConfig.Footer or "OrvezzXe :3"
    ...
    local Orvezz = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    Orvezz.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    Orvezz.Name = "KaizoXX"
    Orvezz.ResetOnSpawn = false
    Orvezz.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = Orvezz

    DropShadowHolder.Position = UDim2.new(0, (Orvezz.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (Orvezz.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    UIStroke.Color = Color3.fromRGB(255, 140, 0)  -- Orange border
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("Orvezz") then
            Orvezz:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Gradient.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0, Color3.fromRGB(255, 140, 0)),   -- Orange
            ColorSequenceKeypoint.new(0.25, Color3.fromRGB(50, 50, 50)),    -- Dark gray
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 165, 0)),    -- Light orange
            ColorSequenceKeypoint.new(0.75, Color3.fromRGB(50, 50, 50)),    -- Dark gray
            ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255, 140, 0))     -- Orange
        })
        ...
        Yes.MouseButton1Click:Connect(function()
            if Orvezz then Orvezz:Destroy() end
    ...
    UIStroke14.Color = Color3.fromRGB(255, 140, 0)  -- Orange
    UIStroke14.Thickness = 2.5
    UIStroke14.Transparency = 0.8
    UIStroke14.Parent = DropdownSelect

    DropdownSelectReal.AnchorPoint = Vector2.new(0.5, 0.5)
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(20, 20, 20)  -- Dark glassmorphism
